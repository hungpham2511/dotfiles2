...
;; Straight: A package for managing package installation.
...
(use-package config-theme
  ...
  (set-face-font 'default "RobotoMono-12") ; Có thể hiển thị được tiếng Việt đầy đủ
...
;;; High-level keybindings
(general-define-key
 :states 'motion
 "<f1>" 'general-describe-keybindings
 
 ;; Search-related
 "C-c C-r p" 'rg-dwim-project-dir
 "C-c C-r c" 'rg-dwim-current-dir
...
(custom-set-variables
 ...
 '(safe-local-variable-values
   '((tramp-remote-process-environment "ENV=''" "TMOUT=0" "LC_CTYPE=''" "CDPATH=" "HISTORY=" "MAIL=" "MAILCHECK=" "MAILPATH=" "PAGER=cat" "autocorrect=" "correct=" "PYTHONPATH=/home/ci/catkin_ws/devel/lib/python3/dist-packages:/opt/ros/noetic/lib/python3/dist-packages:/protos-python")
     (company-backends
