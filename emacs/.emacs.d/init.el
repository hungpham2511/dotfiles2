...
(custom-set-variables
 ...
 '(lsp-python-ms-python-executable-cmd "/home/hung/Envs/NeuroKit-cShUvUNz/bin/python")
 ...
 '(org-link-frame-setup
   '((vm . vm-visit-folder-other-frame)
     ...
     (file . find-file)
     (wl . wl-other-frame)))
 '(org-roam-directory "/home/hung/org/" t)
 '(org-roam-link-title-format '(lambda (title) (s-upper-camel-case title)) t)
