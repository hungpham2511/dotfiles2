...
awful.spawn.with_shell("~/.config/awesome/startup_script.sh")

-- don't do this, define variable in startup_script instead
...
globalkeys = awful.util.table.join(
   ...
   awful.key({ modkey, "Control"}, "k", function ()
	 awful.spawn('/home/hung/.config/awesome/toggle_touchpad') end,
